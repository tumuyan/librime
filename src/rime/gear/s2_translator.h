...
//
#ifndef RIME_S2_TRANSLATOR_H_
#define RIME_S2_TRANSLATOR_H_
...
class S2Translator : public Translator,
                         public Memory,
                         public TranslatorOptions {
 public:
  S2Translator(const Ticket& ticket);
